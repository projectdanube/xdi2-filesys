...
public class XDIFileSys extends HttpServlet implements HttpRequestHandler {

	private static final long serialVersionUID = 8015369727001589601L;

	private static final Logger log = LoggerFactory.getLogger(XDIFileSys.class);
	...
	static {
		...
		while (true) {
			...
			InputStream inputStream = XDIFileSys.class.getResourceAsStream("message" + (sampleInputs.size() + 1) + ".xdi");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/XDIFileSys.jsp").forward(request, response);
	}
