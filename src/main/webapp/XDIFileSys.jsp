...
<body>
	...
	<div id="main">
	<div class="header">
	<span id="appname">xdi2-filesys</span>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<% for (int i=0; i<((Integer) request.getAttribute("sampleInputs")).intValue(); i++) { %>
		<a href="XDIFileSys?sample=<%= i+1 %>">Sample <%= i+1 %></a>&nbsp;&nbsp;
	<% } %>
	</div>
	...
	<form action="XDIFileSys" method="post" accept-charset="UTF-8">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;<a href="XDIFileSysHelp.jsp">What can I do here?</a>
